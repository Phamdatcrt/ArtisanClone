...
def content() -> str:
    ...
    tbl_AutosaveFields.add_row(['~defectsweight',QApplication.translate('HelpDlg','From Roast>Properties>Defects'),0.04])
    tbl_AutosaveFields.add_row(['~yield',QApplication.translate('HelpDlg','From Roast>Properties>Yield'),2.56])
    tbl_AutosaveFields.add_row(['~defectsloss',QApplication.translate('HelpDlg','Calculated defects loss in percent (the  “-” sign is not shown, it can be added manually in front of the field if desired)'),2.3])
    tbl_AutosaveFields.add_row(['~totalloss',QApplication.translate('HelpDlg','Calculated total loss in percent (the  “-” sign is not shown, it can be added manually in front of the field if desired)'),16.1])
    ...
    tbl_AutosaveFields.add_row(['~devtime',QApplication.translate('HelpDlg','Calculated time from DTs to DROP in seconds'),112])
    tbl_AutosaveFields.add_row(['~devtime_long',QApplication.translate('HelpDlg','Calculated time from DTs to DROP in min_secs'),'01_52'])
    ...
    tbl_AutosaveFields.add_row(['~DTset',QApplication.translate('HelpDlg','From the Profile - ET at DTs'),397.4])
    tbl_AutosaveFields.add_row(['~DTsbt',QApplication.translate('HelpDlg','From the Profile -BT at DTs'),386.7])
    tbl_AutosaveFields.add_row(['~DTstime',QApplication.translate('HelpDlg','From the Profile - DTs time in seconds'),490])
    tbl_AutosaveFields.add_row(['~DTstime_long',QApplication.translate('HelpDlg','From the Profile - DTs time in min_secs'),'08_10'])
    ...
    tbl_AutosaveFields.add_row(['~midphasedeltatemp',QApplication.translate('HelpDlg','From the Profile - BT temperature change from DRY to DTs'),78.6])
    tbl_AutosaveFields.add_row(['~finishphasedeltatemp',QApplication.translate('HelpDlg','From the Profile - BT temperature change from DTs to DROP'),19.8])

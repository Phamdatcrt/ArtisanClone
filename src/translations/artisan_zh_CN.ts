...
警报从上至下按顺序发生</translation>
    ...
    <message>
      ...
      <translation>触发 DTs 事件</translation>
    </message>
    <message>
...
加载在较小机器上记录的配置文件并打开 Transposer。选择线性映射并将在大型机器上观察到的 DRY 和 FC START 目标温度放入 BT 下的相应字段中。在表格下方，您会看到计算出的符号公式，可以将其复制粘贴到 Config &gt;&gt; Devices 下的 BT 符号公式中，以便在较小的机器上烘烤时自动调整计算的映射，以在较大的机器上查看您所期望的温度读数.</translation>
    ...
    <message>
      ...
      <translation>从 { START, CHARGE, DRY, DTs, FCe, SCs, SCe, DROP, COOL, OFF } 激活按钮 &lt;名称&gt;</translation>
    </message>
    <message>
...
如果值单位：0.1 / ex. 总是乘以 10。 4719:0 停止加热</translation>
    ...
    <message>
      ...
      <translation>从 { START, CHARGE, DRY, DTs, FCe, SCs, SCe, DROP, COOL, OFF } 激活按钮 &lt;name&gt; ；如果参数为 1 或 True，则将调用按钮设置为“按下”</translation>
    </message>
    <message>
...
100*(t{事件}-t{DTs})/(t{DTs}-t{CHARGE})</translation>
    </message>
    <message>
...
气体 50% @12% DTR</translation>
    ...
    <message>
      ...
      <translation>反引号 ` 之间的任何内容将仅在 FC 前 90 秒内显示。示例：`~E1 `DTs~dDTs sec`</translation>
    </message>
    <message>
...
从烤&gt;属性&gt;豆子</translation>
    ...
    <message>
      ...
      <translation>从配置文件 - BT 温度从 DRY 到 DTs 的变化</translation>
    </message>
    <message>
...
例如，“Y2”返回当前的咖啡豆温度 (BT)，“Y2[-1]”返回之前的 BT 温度，“Y2[-2]”返回之前的温度。绘图仪中使用的公式按顺序应用于所有值，因此“Y2”指向当前处理的 BT 温度，“Y2[-1]”表示处理的前一个 BT 温度，“Y2[+1]”表示下一个 BT 温度待处理。正向偏移仅在绘图仪中可用，显然在记录期间不可用。</translation>
    ...
    <message>
      ...
      <translation>与 pDRY 相同，仅适用于 DTs 事件。</translation>
    </message>
    <message>
...
If there is a background profile and there is DRY or DTs event in the background profile, the DRY or DTs bean temperature used for the prediction is taken from the background profile.</source>
      <translation>
如果存在背景配置文件并且背景配置文件中存在 DRY 或 DTs 事件，则用于预测的 DRY 或 DTs 豆子温度取自背景配置文件。</translation>
    </message>
    <message>
      <location filename="../help/symbolic_help.py" line="122" />
      <source>
...
The prediction value is the calculated time in seconds to reach the DRY or DTs temperature.</source>
      <translation>
预测值是达到 DRY 或 DTs 温度的计算时间（以秒为单位）。</translation>
    </message>
    <message>

...
class phasesGraphDlg(ArtisanDialog):
    def __init__(self, parent:'QWidget', aw:'ApplicationWindow') -> None:
        ...
        self.org_autoDTsFlag = bool(self.aw.qmc.autoDTsFlag)
        ...
        self.autoDTsFlag = QCheckBox(QApplication.translate('CheckBox','Auto DTs'))
        self.autoDTsFlag.setChecked(bool(self.aw.qmc.autoDTsFlag))
        ...
        self.autoDTsFlag.stateChanged.connect(self.autoDTsFlagChanged)
        ...
        boxedPhaseFlagGrid.addWidget(self.autoDTsFlag,1,1)
    ...
    def bevents2phases(self) -> None:
        if self.aw.qmc.phasesfromBackgroundflag and self.aw.qmc.backgroundprofile is not None:
            # adjust phases by DryEnd and DTs events from background profile
    ...
    def events2phases(self) -> None:
        if self.aw.qmc.phasesbuttonflag:
            # adjust phases by DryEnd and DTs events
    ...
    @pyqtSlot(int)
    def autoDTsFlagChanged(self, _:int) -> None:
        self.aw.qmc.autoDTsFlag = not self.aw.qmc.autoDTsFlag
        if self.aw.qmc.autoDTsFlag:
            self.pushbuttonflag.setChecked(False)
    ...
    def pushbuttonflagChanged(self, i:int) -> None:
        ...
        if self.aw.qmc.phasesbuttonflag:
            ...
            self.autoDTsFlag.setChecked(False)
...
#        self.aw.closeEventSettings()
    ...
    def cancel(self) -> None:
        ...
        self.aw.qmc.autoDTsFlag = bool(self.org_autoDTsFlag)

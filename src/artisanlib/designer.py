...
class designerconfigDlg(ArtisanDialog):
    def __init__(self, parent:'QWidget', aw:'ApplicationWindow') -> None:
        ...
        self.DTs = QCheckBox(QApplication.translate('CheckBox','FC START'))
        self.DTs.setStyleSheet('background-color: orange')
        ...
        self.DTs.clicked.connect(self.changeflags)
...
#        regextime = QRegularExpression(r'^-?[0-9]?[0-9]?[0-9]:[0-5][0-9]$')
        ...
        marksLayout.addWidget(self.DTs,3,0)
...
#        self.aw.qmc.convert_designer()
    ...
    def loadconfigflags(self) -> None:
        ...
        self.DTs.setChecked(bool(self.aw.qmc.timeindex[2]))
    ...
    def changeflags(self, _:bool = False) -> None:
        ...
        if self.validatetimeorder() != 1000:
            ...
            elif idi == 2 and self.DTs.isChecked():
                self.DTs.setChecked(False)

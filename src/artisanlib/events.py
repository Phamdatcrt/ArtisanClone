...
class EventsDlg(ArtisanResizeablDialog):
    def __init__(self, parent:QWidget, aw:'ApplicationWindow', activeTab:int = 0) -> None:
        ...
        Epreview1Label.setText(QApplication.translate('Label', 'Example before DTs'))
        ...
        Epreview2Label.setText(QApplication.translate('Label', 'Example after DTs'))
        ...
        self.E1Preview1 = QLabel(self.aw.qmc.parseSpecialeventannotation(self.E1Edit.text(),eventnum=0,applyto='preview',postDTs=False))
        self.E1Preview2 = QLabel(self.aw.qmc.parseSpecialeventannotation(self.E1Edit.text(),eventnum=0,applyto='preview',postDTs=True))
        ...
        self.E2Preview1 = QLabel(self.aw.qmc.parseSpecialeventannotation(self.E2Edit.text(),eventnum=0,applyto='preview',postDTs=False))
        self.E2Preview2 = QLabel(self.aw.qmc.parseSpecialeventannotation(self.E2Edit.text(),eventnum=0,applyto='preview',postDTs=True))
        ...
        self.E3Preview1 = QLabel(self.aw.qmc.parseSpecialeventannotation(self.E3Edit.text(),eventnum=0,applyto='preview',postDTs=False))
        self.E3Preview2 = QLabel(self.aw.qmc.parseSpecialeventannotation(self.E3Edit.text(),eventnum=0,applyto='preview',postDTs=True))
        ...
        self.E4Preview1 = QLabel(self.aw.qmc.parseSpecialeventannotation(self.E4Edit.text(),eventnum=0,applyto='preview',postDTs=False))
        self.E4Preview2 = QLabel(self.aw.qmc.parseSpecialeventannotation(self.E4Edit.text(),eventnum=0,applyto='preview',postDTs=True))
...
#        AutoMarkGroupBox.setSizePolicy(QSizePolicy.Policy.Fixed,QSizePolicy.Policy.Fixed)
        ...
        self.DTsbutton = QCheckBox(QApplication.translate('CheckBox', 'FC START'))
        self.DTsbutton.setChecked(bool(self.aw.qmc.buttonvisibility[2]))
        self.DTsbutton.setToolTip(QApplication.translate('Tooltip', 'Display the button during roast'))
        self.DTsbuttonActionType = QComboBox()
        self.DTsbuttonActionType.setToolTip(QApplication.translate('Tooltip', 'Action type to fire when the button is clicked'))
        self.DTsbuttonActionType.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        self.DTsbuttonActionType.addItems(self.buttonActionTypesSorted)
        self.DTsbuttonActionType.setCurrentIndex(self.buttonActionTypesSorted.index(self.buttonActionTypes[self.aw.qmc.buttonactions[2]]))
        self.DTsbuttonActionString = QLineEdit(self.aw.qmc.buttonactionstrings[2])
        self.DTsbuttonActionString.setToolTip(QApplication.translate('Tooltip', 'Event action command'))
        ...
        defaultButtonsLayout.addWidget(self.DTsbutton,0,4)
        defaultButtonsLayout.addWidget(self.DTsbuttonActionType,0,5)
        defaultButtonsLayout.addWidget(self.DTsbuttonActionString,0,6)
...
###########################################
    ...
    def specialeventEditchanged(self, n:int) -> None:
        if n == 1:
            self.E1Preview1.setText(self.aw.qmc.parseSpecialeventannotation(self.E1Edit.text(),eventnum=0,applyto='preview',postDTs=False))
            self.E1Preview2.setText(self.aw.qmc.parseSpecialeventannotation(self.E1Edit.text(),eventnum=0,applyto='preview',postDTs=True))
            self.aw.qmc.specialeventannotations[0] = self.E1Edit.text()
        if n == 2:
            self.E2Preview1.setText(self.aw.qmc.parseSpecialeventannotation(self.E2Edit.text(),eventnum=0,applyto='preview',postDTs=False))
            self.E2Preview2.setText(self.aw.qmc.parseSpecialeventannotation(self.E2Edit.text(),eventnum=0,applyto='preview',postDTs=True))
            self.aw.qmc.specialeventannotations[1] = self.E2Edit.text()
        if n == 3:
            self.E3Preview1.setText(self.aw.qmc.parseSpecialeventannotation(self.E3Edit.text(),eventnum=0,applyto='preview',postDTs=False))
            self.E3Preview2.setText(self.aw.qmc.parseSpecialeventannotation(self.E3Edit.text(),eventnum=0,applyto='preview',postDTs=True))
            self.aw.qmc.specialeventannotations[2] = self.E3Edit.text()
        if n == 4:
            self.E4Preview1.setText(self.aw.qmc.parseSpecialeventannotation(self.E4Edit.text(),eventnum=0,applyto='preview',postDTs=False))
            self.E4Preview2.setText(self.aw.qmc.parseSpecialeventannotation(self.E4Edit.text(),eventnum=0,applyto='preview',postDTs=True))
...
#            valueEdit.setValidator(QRegExpValidator(QRegExp(r"^100|\-?\d?\d?$"),self)) # QRegExp(r"^100|\d?\d?$"),self))
    ...
    def updatetypes(self) -> None:
        try:
            ...
            self.aw.qmc.buttonvisibility[2] = self.DTsbutton.isChecked()
            self.aw.buttonDTs.setVisible(bool(self.aw.qmc.buttonvisibility[2]))
            ...
            self.aw.qmc.buttonactions[2] = self.buttonActionTypes.index(self.buttonActionTypesSorted[self.DTsbuttonActionType.currentIndex()])
            ...
            self.aw.qmc.buttonactionstrings[2] = self.DTsbuttonActionString.text()

...
#        color_stopbitslabel.setBuddy(self.color_stopbitsComboBox)
        ...
        self.ws_DTs = QLineEdit(str(self.aw.ws.DTs_node))
        self.ws_DTs.setSizePolicy(QSizePolicy.Policy.Expanding,QSizePolicy.Policy.Fixed)
        self.ws_DTs.setCursorPosition(0)
        ...
        ws_events.addWidget(QLabel(QApplication.translate('Label','DTs')),0,4)
        ws_events.addWidget(self.ws_DTs,1,4)

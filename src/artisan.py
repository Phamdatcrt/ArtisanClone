...
if system().startswith('Windows'):
    ...
    # on Linux, the platform plugin cocoa/windows is not found in the plugin directory (despite the qt.conf file) if we do not
    # extend the libraryPath accordingly
    # on macOS, the platform plugin cocoa is not found in the plugin directory (des
    try:
